...
## GG Line
gg.line <- ggplot(ent, aes(x = pos, y=ma*2)) + 
  geom_line()+
...
gg.box <- ggplot(ent, aes(x = pos, y=ma, group=pos, colour=structure)) + 
...
Fig1 <- gg.primers / gg.line / gg.box + plot_layout(heights=c(2,4, 1))
```
