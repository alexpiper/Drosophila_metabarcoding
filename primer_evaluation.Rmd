...
write_csv(joint, "primer_evaluation/amplicons/mixed_clusters_summary.csv")
...
gg.id <- ggplot(joint, aes(x=amplicon, y=success, colour=combos))+
  ...
  facet_grid(threshold~type, scales="free_y") +
...
# COuld model ID success by amplicon length with LCO/HCO as the intercept. Look at those that are significantly above as successfuly 
...
sbatch --array=1-29 primerblast.slurm
