...
ps <- readRDS("pcrbias_paper_code-master/dada2_gut/phyloseq.rds")

# load added metadata
path.addedmeta <- "pcrbias_paper_code-master/gut_updated_metadata/2017.08.14MappingFile_addedmetadata.txt"
...
ps <- speedyseq::tax_glom(ps, "Genus")
